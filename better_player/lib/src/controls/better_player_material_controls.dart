...
class BetterPlayerMaterialControls extends StatefulWidget {
  ...
  /// Callback available for long press tap interaction
  final VoidCallback? onLongPress;

  /// Callback available for dragging on the horizontal axis
  final ValueChanged<DragEndDetails>? onHorizontalDragEnd;

  /// Callback available for dragging on the vertical axis
...
class _BetterPlayerMaterialControlsState extends BetterPlayerControlsState<BetterPlayerMaterialControls> {
  ...
  Widget _buildHitAreaClickableButton({Widget? icon, required VoidCallback onTap, VoidCallback? onLongPress}) {
    return Container(
