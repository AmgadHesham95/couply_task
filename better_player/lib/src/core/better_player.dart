...
import 'package:better_player/src/core/better_player_preview.dart';
...
class BetterPlayer extends StatefulWidget {
  ...
  factory BetterPlayer.network(String url, {BetterPlayerConfiguration? betterPlayerConfiguration}) {
    return BetterPlayer(
...
class _BetterPlayerState extends State<BetterPlayer> with WidgetsBindingObserver {
  ...
  Future<void> onControllerEvent(BetterPlayerControllerEvent event) async {
    switch (event) {
  ...
  Widget _fullScreenRoutePageBuilder(
    ...
    if (widget.controller.isPlaying()!) widget.controller.play();
  ...
  Widget build(BuildContext context) {
    return (!widget.controller.isFullScreen)
