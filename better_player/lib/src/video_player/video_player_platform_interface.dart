...
abstract class VideoPlayerPlatform {
  ...
  Future<int?> create(
      {BetterPlayerBufferingConfiguration? bufferingConfiguration, BetterPlayerDataSource? dataSource}) {
  ...
  Future<void> setTrackParameters(int? textureId, int? width, int? height, int? bitrate, int? trackId) {
