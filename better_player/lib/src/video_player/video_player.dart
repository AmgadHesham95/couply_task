...
class VideoPlayerController extends ValueNotifier<VideoPlayerValue> {
  ...
  Future<void> setTrackParameters(int? width, int? height, int? bitrate, int? trackId) async {
    await _videoPlayerPlatform.setTrackParameters(_textureId, width, height, bitrate, trackId);
  }
